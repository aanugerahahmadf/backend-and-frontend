...
const MapContainer = dynamic(
  ...
  { ssr: false, loading: () => <div className="w-full h-full bg-gradient-to-br from-blue-950/30 to-slate-900/30 flex items-center justify-center"><div className="text-white">Loading Maps...</div></div> }
)
          ...
          <div className="h-[50vh] sm:h-[60vh] md:h-[70vh] w-full max-w-4xl rounded-2xl overflow-hidden shadow-2xl z-0">
            <div className="w-full h-full bg-gradient-to-br from-blue-950/30 to-slate-900/30 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-white/50 font-semibold">Loading Maps...</p>
              </div>
            </div>
          </div>
        </div>
              ...
              {selectedBuilding.rooms && Array.isArray(selectedBuilding.rooms) ? (
                selectedBuilding.rooms.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-white/50">No rooms found for this building</p>
                  </div>
                )
              ) : (
                <div className="text-center py-8">
                  <p className="text-white/50">Error loading room data</p>
                </div>
              )}
            </div>
